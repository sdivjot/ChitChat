    ...
    setFile(URL.createObjectURL(selectedFile));
      ...
      try {
        const response = await axios.post(
          "https://api.cloudinary.com/v1_1/dv2tahdfu/image/upload",
          formData
        );
        const imageUrl = response.data.secure_url;
        // Do something with the imageUrl (e.g. save it to your database)
  ...
  const onSubmit = async (data) => {
    ...
    await axios
      ...
      .then((response) => {
        ...
        localStorage.setItem("ChitChat", JSON.stringify(response.data));
